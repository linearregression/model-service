...
import modelservice.storage.StorageActorSet
import modelservice.web.Web

object Boot extends App with InitCore with Api with Web with CoreActorSet with PredictionActorSet with StorageActorSet